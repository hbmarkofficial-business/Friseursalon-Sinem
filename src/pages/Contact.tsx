...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Kontakt & Termin | Friseursalon Mousa Mönchengladbach</title>
        <meta 
          name="description" 
          content="Kontaktieren Sie Friseursalon Mousa in Mönchengladbach. Vereinbaren Sie Ihren Termin über unseren Chatbot oder rufen Sie uns an. Mo-Sa 09-19 Uhr." 
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5000.812029907434!2d6.43216259357909!3d51.19316989999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b8ac90f8340877%3A0xedfa0496d2d9157c!2sFriseursalon%20Sinem!5e0!3m2!1sde!2sde!4v1770932380535!5m2!1sde!2sde",
              ...
              <AnimateOnScroll animation="slide-left" className="order-1 lg:order-1">
                <div className="bg-card border border-border rounded-sm p-8 md:p-10 h-fit">
                  <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-6">
                    <span className="text-primary text-2xl">M</span>
                  </div>
              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5000.812029907434!2d6.43216259357909!3d51.19316989999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b8ac90f8340877%3A0xedfa0496d2d9157c!2sFriseursalon%20Sinem!5e0!3m2!1sde!2sde!4v1770932380535!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
                      ...
                      title="Standort Friseursalon Mousa"
                    />
                  </div>
                </div>
              </AnimateOnScroll>
