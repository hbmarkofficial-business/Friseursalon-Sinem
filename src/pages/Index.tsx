  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Mönchengladbach | Friseursalon Sinem</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Sinem in Mönchengladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Friseursalon Sinem | Premium Friseursalon Mönchengladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Friseursalon Sinem | Premium Friseursalon Mönchengladbach" />
        <meta
